...
class ArrayQueue:
    ...
    def __init__(self, capacity: int = 10) -> None:
        ...
        self._queue: list[int] = [None] * self._capacity # 用于存储队列元素的数组
    ...
    def dequeue(self) -> int:
        ...
        result: int = self._queue[self._head]
    ...
    def to_list(self) -> list[int]:
        ...
        for i in range(self._size):
            cur: int = self._queue[(self._head + i) % self._capacity]
            result[i] = cur
        return result
